                                ...
                                <div class="row g-0 align-items-center"> <!-- Ensure content is vertically centered -->
                                    ...
                                    <div class="col my-2">
                                        <div class="card-body row">
                                            <div class="col-8">
                                                <h2 class="my">{{ $car->carModel->carBrand->brand }}
                                                    {{ $car->carModel->model }}
                                                    {{ $car->year }}</h2>
                                            ...
                                            <div class="col-4">
                                                <p class="text-right text-muted">{{ $car->status }}</p>
                                                @if ($car->status === 'On Progress')
                                                    <p class="text-right text-muted">
                                                        {{ \Carbon\Carbon::createFromFormat('Y-m-d', $car->inspection_date)->format('d-m-Y') }}
                                                    </p>
                                                @endif
                                            </div>
