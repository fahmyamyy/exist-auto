                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="tempatLahir" id="tempatLahir" required>
                                ...
                                @foreach (json_decode(file_get_contents('https://www.emsifa.com/api-wilayah-indonesia/api/provinces.json')) as $tempat)
                                    <option value="{{ $tempat->name }}" @if ($tempat->name == $user->tempat_lahir) selected @endif>
                                        {{ $tempat->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="agama" id="agama" required>
                                ...
                                <option value="Kristen Protestan" @if ($user->agama == 'Kristen Protestan') selected @endif>Kristen
                                    Protestan</option>
                                <option value="Kristen Katolik" @if ($user->agama == 'Kristen Katolik') selected @endif>Kristen
                                    Katolik</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="penghasilanPerbulan" id="penghasilanPerbulan"
                                value="{{ $user->penghasilan_perbulan }}" disabled>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="statusPerkawinan" id="statusPerkawinan" required>
                                ...
                                <option value="Lajang" @if ($user->status_perkawinan == 'Lajang') selected @endif>Lajang</option>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pinjamanSebelumnya" id="pinjamanSebelumnya"
                                value="{{ $user->pinjaman_sebelumnya }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
